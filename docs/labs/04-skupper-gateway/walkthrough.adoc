...
4. This will start the pyament processor in your namespace.

=== Deploy the database

1. Click the *+Add* tab in the top left side of the console to start again the process to deploy now the database.
+
...
[NOTE]
====
There is a service accesible in the namespace for the _database_ and the _payment-processor_ backend services.
====
