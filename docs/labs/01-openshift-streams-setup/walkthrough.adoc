...
. Select your Service Account in th *Account* dropdown.
...
[NOTE]
====
The access rules assigned during this lab are very permissive. In production you should provide a Service Account with access to specific resources, and avoid using wildcards (`*`) if possible.
====
